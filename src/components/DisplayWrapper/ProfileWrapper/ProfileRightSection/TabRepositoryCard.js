...
import "./TabRepositoryCard.css";

const TabRepositoryCard = (props) => {
  return (
    <div className="TabRepositoryCard">
      <div className="repo-list-item-content">
        <div className="repo-icon-title-visibility">
          {/* <svg
            aria-hidden="true"
            height="16"
            viewBox="0 0 16 16"
        ...
        <div className="repo-footer">
          <div className="repo-code-language">
            <span className={`repo-language-color ${props.language}`}></span>
            <span className="programming-language">{props.language}</span>
          </div>
...
export default TabRepositoryCard;
