...
const InformationComponent = () => {
  ...
  return (
    <div className={`InformationComponent ${isEdit ? "hide" : ""}`}>
      <div className="name">
      ...
      <div className="user-status-container">
        ...
        <div className="followers-following">
          <a href="">
            ...
            <span className="followers-count">{userData.followers}</span>
            followers
          </a>
          ·
          <a href="">
            <span className="following-count">{userData.following}</span>
            following
          </a>
        </div>
        <div className="user-details">
          <ul>
            <li className={userData.company ? "" : "hide"}>
              <svg
            ...
            <li className={userData.location ? "" : "hide"}>
              <svg
            ...
            <li className={userData.email ? "" : "hide"}>
              <svg
            ...
            <li className={userData.blog ? "" : "hide"}>
              <svg
                // style={"width: 16px;"}
                aria-hidden="true"
                height="16"
            ...
            <li className={userData.twitter_username ? "" : "hide"}>
              <svg
